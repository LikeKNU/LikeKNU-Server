...
import ac.knu.likeknu.collector.bus.BusArrivalTimeRequestManager;
import ac.knu.likeknu.collector.bus.DepartureStop;
import ac.knu.likeknu.collector.bus.MapType;
...
public class BusArrivalTimeScheduleService {
    ...
    private final BusArrivalTimeProducer busArrivalTimeProducer;

    public BusArrivalTimeScheduleService(BusArrivalTimeRequestManager busArrivalTimeRequestManager, BusArrivalTimeProducer busArrivalTimeProducer) {
    ...
    public void schedulingBusArrivalTimeProduce() {
        List<BusArrivalTime> busArrivalTimes = Arrays.stream(DepartureStop.values())
                ...
                .toList();
        busArrivalTimeProducer.produce(busArrivalTimes);
    }
