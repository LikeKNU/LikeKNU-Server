...
@Builder
public record AcademicCalendarDto(@NotBlank LocalDate startDate, @NotBlank LocalDate endDate, @NotBlank String contents) {

    public static AcademicCalendarDto of(String yearValue, String date, String contents) {
        LocalDate startDate;
        LocalDate endDate;
